// src/lib.rs
/*
 * Core library for VoiceAssistant
 */
...
#[derive(Debug)]
pub struct VoiceAssistantProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VoiceAssistantProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VoiceAssistant processing");
    
    let mut processor = VoiceAssistantProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VoiceAssistantProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VoiceAssistantProcessor::new(false);
